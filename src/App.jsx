...
function App() {
  ...
  return (
    <>
    <Header logo="Family Wellness" logo_des="MASSAGE THERAPY" link1="HOME" link2="ABOUT" link3="SERVICES" link4="FAQ" link5="CONTACT"/>
    <Hero heading="Think Helth. Think Massage" hero_para="We are open 9am to 6pm;
    ...
    />
    <Footer heading="Family Wellness Massage Therapy "
